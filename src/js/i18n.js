...
var DICT = {
  ...
  'hero.kicker': { pt: '// SOFTWARE · AUTOMACAO · SECURITY', en: '// SOFTWARE · AUTOMATION · SECURITY' },
  'hero.intro': {
    pt: 'Engenheiro de Software Full Stack especializado no desenvolvimento de aplicacoes web escalaveis, sistemas de automacao ponta a ponta, APIs REST, agentes de IA e infraestrutura Linux.',
  ...
  'hero.ctaContact':  { pt: 'falar comigo', en: 'get in touch' },
  ...
  'about.intro': {
    pt: 'Engenheiro de Software Full Stack com experiencia no desenvolvimento de solucoes completas para e-commerce, logistica, analytics e automacao de processos. Meu foco e unir backend robusto (Clean Architecture & SOLID), integracoes de IA/LLMs e praticas de desenvolvimento seguro.',
  ...
  'about.muted': {
    pt: 'Experiencia na construcao de microsservicos, web scraping avancado, infraestrutura self-hosted em Linux/Docker e pipelines de dados first-party.',
  ...
  'projects.description': {
    pt: 'Aplicacoes, utilitarios e experimentos que representam o que tenho estudado e colocado em pratica.',
  ...
  'proj.animecaos.desc': {
    pt: 'Aplicacao desktop que agrega fontes brasileiras, pesquisa conteudo e consulta metadados do AniList.',
  ...
  'proj.dashboard.desc': {
    pt: 'Dashboard first-party para rastrear visitas, cliques e instalacoes sem depender de terceiros.',
  ...
  'proj.xmlrpc.desc': {
    pt: 'Ferramenta de estudo para testes autorizados no endpoint XML-RPC de instalacoes WordPress.',
  ...
  'proj.winopt.desc': {
    pt: 'Utilitario para ajustes de privacidade e desempenho em ambientes Windows corporativos.',
  ...
  'proj.auditflow.desc': {
    pt: 'Audita um site inteiro com um comando e devolve um relatorio so: performance, SEO, acessibilidade, responsividade, crawling e stress test consolidados em seis blocos com nota e evidencia.',
  ...
  'proj.caoshub.desc': {
    pt: 'Hub de ferramentas que executa processamento no navegador, sem uploads ou dependencia de servidor.',
    en: 'Tool hub that runs processing entirely in the browser, with no uploads or server dependency.'
  },

  'proj.schulze.alt':      { pt: 'Site Studio Schulze', en: 'Studio Schulze website' },
  'proj.schulze.category': { pt: '09 / WEB', en: '09 / WEB' },
  'proj.schulze.desc': {
    pt: 'Landing page responsiva para um estudio de arquitetura, organizada para apresentar o trabalho com clareza.',
    en: 'Responsive landing page for an architecture studio, organized to present the work clearly.'
  },

  'lab.kicker': { pt: '// 03. SECURITY LAB & CERTIFICACOES', en: '// 03. SECURITY LAB & CERTIFICATIONS' },
  'lab.title':  { pt: 'Seguranca e parte<br>da construcao.', en: 'Security is part<br>of the build.' },
  'lab.description': {
    pt: 'Pratico desenvolvimento seguro, hardening de servidores e analise ofensiva. Certificacoes verificaveis em Pentesting, Ciberseguranca e Python para OffSec.',
  ...
  'stack.title':  { pt: 'Tecnologias para<br><em>solucoes de impacto.</em>', en: 'Technologies for<br><em>impactful solutions.</em>' },
  ...
  'journey.title':  { pt: 'Experiencia e<br>evolucao continua.', en: 'Experience and<br>continuous growth.' },
  'journey.job1.title': { pt: 'Engenheiro de Software — Coutinho Companhia', en: 'Software Engineer — Coutinho Companhia' },
  'journey.job1.desc': {
    pt: 'Desenvolvimento de aplicacoes web, sistemas de automacao escalaveis, integracoes com marketplaces (Mercado Livre, Amazon), agentes de IA e gestao de infraestrutura Linux/Docker em producao.',
  ...
  'journey.job2.desc': {
    pt: 'Especializacao em desenvolvimento seguro, Pentest e Ciberseguranca com certificacoes Solyd, Desec, IBM e Red Team Leaders.',
  ...
  'journey.job3.desc': {
    pt: 'Criacao de ferramentas como Analytics First-Party, AnimeCaos-dlp e XMLRPC-Bruteforce com foco em alta performance e utilidade real.',
  ...
  'contact.description': {
    pt: 'Disponivel para oportunidades, colaboracoes e projetos interessantes.',
  ...
  'meta.description': {
    pt: 'Portfolio de Henrique Lanzoni — software, automacao e pesquisa de seguranca.',
